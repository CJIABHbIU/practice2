...
import ru.ssau.tk.way.practice2.exceptions.IncompatibleDimensionsException;

public class Matrices extends IncompatibleDimensionsException {
    public static Matrix sumOfMatrices(Matrix first, Matrix second) throws IncompatibleDimensionsException {
    ...
    public static Matrix multiplicationOfMatrices(Matrix first, Matrix second) throws IncompatibleDimensionsException {
