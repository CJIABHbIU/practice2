...
import static ru.ssau.tk.way.practice2.arrays.Matrices.*;

public class MatricesTest {
    private final double DELTA = 0.0001;

    @Test
    public void testSumOfMatrices() throws IncompatibleDimensionsException {
    ...
    @Test
    public void testMultiplicationOfMatrices() throws IncompatibleDimensionsException {
        Matrix firstMatrix = new Matrix(3, 2);
